...
• music — how to find a ROYALTY-FREE INSTRUMENTAL track. We do NOT have copyrighted/famous music — never name a famous song; translate it to a vibe. The object:
   ‣ tags — 0-3 from this exact list (genre + mood + occasion): ${[...JAMENDO_TAGS].join(", ")}.
     Tags are the SHARPEST signal. Good mappings:
       ...
       jazz / smooth jazz / slow jazz / lofi jazz -> JUST ["jazz"] (one tag — the wider pool surfaces the actually-good jazz instrumentals on Jamendo). For tempo: "slow"=ballad/smooth, "medium"=lounge/cafe, "fast"=bebop/upbeat. acoustic_or_electric:"acoustic" for piano/sax/trio, "electric" for funk-jazz/jazz-fusion. CRITICAL: do NOT add "relaxing"/"lounge"/"ambient" alongside "jazz" for a jazz request — that combo over-narrows to obscure background-music tracks. Just ["jazz"] + tempo + acoustic/electric is correct.
